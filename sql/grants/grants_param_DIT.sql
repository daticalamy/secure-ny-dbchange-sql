...
BEGIN
  ...
  FOR v1 as
      ...
      DO
	    ...
	    set v_select_group_stmt = 'GRANT SELECT ON TABLE '||CREATOR||'.'||NAME ||' to GROUP "HXAAPPL", GROUP "HXAPPL", GROUP "HXETL", GROUP "HXFSTEW", GROUP "HXPRPT", GROUP "HXPTWDEV", GROUP "HXTEST", GROUP "HXUST1", GROUP "HXUTEST", GROUP "HXUTSTUP"'; 
	    set v_select_user_stmt = 'GRANT SELECT ON TABLE '||CREATOR||'.'||NAME ||' to USER "CSAPP1","EEAPP1","HXETL1","HXRPT1","PMAPP1","SHAPP1","SVC_DAST","SVC_DENC","SVC_DFMS"'; 
